                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white"> 
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $event->title}}</td>
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $event->body }}</td>
